...
#
# Script generated by Vivado on Sat May 09 20:31:03 +0700 2026
...
#                frame_buffer.sh [-rerun]
#                frame_buffer.sh [-reset_run]
#                frame_buffer.sh [-clean]
...
# script info
echo -e "frame_buffer.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot frame_buffer xil_defaultlib.frame_buffer xil_defaultlib.glbl -log elaborate.log
}
...
Usage: frame_buffer.sh [-rerun]\n\
Usage: frame_buffer.sh [-reset_run]\n\
Usage: frame_buffer.sh [-clean]\n\
